...
test = Test.create([{title:'Ruby', level: 2, category_id: category[0].id, author: user[0].id},
...
answer = Answer.create([{body: 'I known methods : puts, print, p, pp, ap', correct: true, question_id: question[0].id},
